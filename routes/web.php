...
Route::view('propertyAlerts','propertyAlerts')->name('propertyAlerts');
    ...
    Route::post('/agent/register',[AgentController::class, 'registerAgent'])->name('agent.register');
    Route::get('/agent/register',[AgentController::class, 'registerForm'])->name('agent.form');
    Route::resource('agent', AgentController::class);
